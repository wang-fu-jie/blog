...
## 八、字典总结
在本文中，我们介绍了字典是如何实现的，以及rehash是如何进行的。 这已经包含了字典的核心模块。但是字典的实现源文件有两千多行代码，我们不可能把每个细节都讲到。例如什么时候触发 rehash？rehash 扩容扩多大？暂停rehash是如何实现的？等等，这些疑问都可以在源代码中找到答案。感兴趣的读者可以在评论区分享你的问题和答案。
