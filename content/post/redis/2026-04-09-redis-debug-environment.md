...
date:        2026-04-09T13:54:06+08:00
author:      "王富杰"
...
### 1.1、拉取redis_debug镜像
为了方便，我这里将已经构建的镜像上传到了阿里云镜像中心，读者可以自行拉取。当然前提需要安装docker，docker的安装步骤本文就不再细说，网上有大量的文章指导。我们这里直接进行镜像的拉取和容器的创建。
```shell
# 拉取镜像
...
[redis设计与实现1](https://redisbook.readthedocs.io/en/latest/index.html)
[redis设计与实现2](https://book-redis-design.netlify.app/#/doc/01-%E5%BC%95%E8%A8%80)