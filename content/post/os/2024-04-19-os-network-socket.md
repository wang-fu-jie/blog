...
date:        2024-04-19T16:58:58+08:00
author:      "王富杰"
...
## 五、总结
这两个套接字其实在上层网络程序开发中基本用不到，例如我们经常使用的TCP套接字，接收和发送的是最终的数据内容。但是如果使用数据包套接字，它没有端口的概念，只有是发给我的网卡的数据包都能收到，无论是哪个端口。也是说这个套接字可以用来抓网卡的所有流量包。
